...
class Organismo_Model extends \Libs\Model {
	...
	public function carregar_organismo($id){
		...
		->leftJoin('organismo_relaciona_nome_popular rel_pop_name'
				. ' ON rel_pop_name.id_organismo = organismo.id AND rel_pop_name.ativo = 1')
		...
		->leftJoin('posicao_geografica geografica'
				. ' ON geografica.id_organismo = organismo.id AND geografica.ativo = 1')
		->leftJoin('organismo_relaciona_imagem rel_imagem'
				. ' ON rel_imagem.id_organismo = organismo.id AND rel_imagem.ativo = 1 ')
		...
		->leftJoin('organismo_relaciona_trabalho rel_trabalho'
				. ' ON rel_trabalho.id_organismo = organismo.id AND rel_trabalho.ativo = 1')
		...
		->leftJoin('taxon taxon'
				. ' ON taxon.id = organismo.id_last_taxon')
